...
#BASEDIR_SUPERFLOAT="/g100_work/OGS_devC/V10C/RUNS_SETUP/ONLINE/SUPERFLOAT"
#INPUT_DS="SUPERFLOAT"

# si presuppone che queste siano gia presenti 
#mkdir -p ds
#mkdir -p ds/${INPUT_DS}

# solo per mettere un po di float e fare un test
#cp -r $BASEDIR_SUPERFLOAT/690177* ds/${INPUT_DS}
#cp -r $BASEDIR_SUPERFLOAT/*txt ds/${INPUT_DS}
