...
k200 = TheMask.getDepthIndex(200)+1
...
for im in range(1,13):
    ...
    for aType in DICTind.keys():
        print ' ... ' + aType
        evc = np.zeros((nSub,neof,k200+1))
        eva = np.zeros((nSub,neof))
        mprof = profiles[ii,:,DICTind[aType],:k200+1,0]
        for kk in range(1,k200+1):
