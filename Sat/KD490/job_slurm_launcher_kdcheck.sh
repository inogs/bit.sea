...
ORIGDIR=/gpfs/scratch/userexternal/gcoidess/TMP_DOWNLOAD/KD490_orig/
CHECKDIR=/gpfs/scratch/userexternal/gcoidess/TMP_DOWNLOAD/KD490_checked/
CLIMFILE=/gpfs/scratch/userexternal/gcoidess/SAT/KD490_Climatology_1km.nc
SATMESH=SAT1km_mesh

my_prex_or_die "mpirun python sat_check_kd.py -i $ORIGDIR -o $CHECKDIR -c $CLIMFILE -m $SATMESH"
