...
DAILY_1km_DIR=/gpfs/scratch/userexternal/ateruzzi/SAT_1km_2013/DAILY/
DAILY_4_DIR=/gpfs/scratch/userexternal/ateruzzi/SAT_4/DAILY/
MASKFILE=/gpfs/scratch/userexternal/ateruzzi/MASKS4/meshmask.nc


mkdir -p $DAILY_4_DIR
echo mpirun -np 10 python interpolator.py -i $DAILY_1km_DIR -o $DAILY_4_DIR --inmesh SAT1km_mesh  -m Mesh4 -M $MASKFILE
