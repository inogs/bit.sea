...
swm1 = SimplePolygonalBasin('swm1', swm1)

swm2 = Polygon([5, 9.25,  9.25, 5 ],
               [32.0,32.00, 39.50,39.5 ])
swm2 = SimplePolygonalBasin('swm2', swm2)
