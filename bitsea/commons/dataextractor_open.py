...
class DataExtractor(object):
    ...
    It works in specific way for 1/24 grid with open dardanelles, where at the moment
    diagnostic variables are zero at open boundary.
    Zeroes are replaced with nearest good value.
    """
            ...
            try:
                ...
                if not v in dset.variables:
                    ...
                    if dimvar==3:
                        ...
                        self.__values[~mask.mask] = 1.e+20
