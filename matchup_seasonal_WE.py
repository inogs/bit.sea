...
for iseas in range(len(SEAS_STR)):  
    ...
    count1, sigma1, bias_val1, corr_coeff1, r1, p1, float_mean1, model_mean1 = calc_statistics(FLOAT_W, MODEL_W) 
    count2, sigma2, bias_val2, corr_coeff2, r2, p2, float_mean2, model_mean2 = calc_statistics(FLOAT_E, MODEL_E)
    ...
    f_out1    = writefile(file_out1, args.var, count1, sigma1, corr_coeff1, bias_val1, r1, p1, float_mean1, model_mean1)
    f_out2    = writefile(file_out2, args.var, count2, sigma2, corr_coeff2, bias_val2, r2, p2, float_mean2, model_mean2)
