...
tyr1 = Polygon([09.25, 15.00, 10, 09.25], [41.25, 41.25, 46, 46.00])
...
tyr = ComposedBasin("tyr", [tyr1, tyr2], "Tyrrhenian Sea")
swm = ComposedBasin("swm", [swm1, swm2], "South Western Mediterranean Sea")
