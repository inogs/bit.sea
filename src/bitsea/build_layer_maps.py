...
try:
    ...
    warn("mpi4py is not installed. This script will not run in parallel")
...
try:
    ...
    print(
        "You should run this script from the bit.sea root directory.",
        file=sys.stderr,
    )
    sys.exit(2)
...
mb.plot_maps_data(
    mapobj, background_img=logo, maptype=1, nranks=nranks, rank=rank
)
