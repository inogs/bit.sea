...
class Matchup_Manager():
    ...
    def getMatchups(self,Profilelist,nav_lev,model_varname, read_adjusted=True, interpolation_on_Float=True, refvar=None, MATCHUP_FLOAT_flag=False):
        '''
        Arguments
        ...
        * interpolation_on_Float * boolean,
        ...
        # CA-VDB 02-2025 # LF QUID 35.2
        # value changed in date 12-03-25 P_l old 6.7
        THRESHOLDS_insitu={'O2o': 40.0, \
                'N1p': 0.3, \
                'N3n': 20.,  \
                'N4n': 1.0,  \
                'N5s': 5.0,  \
        ...
        if MATCHUP_FLOAT_flag:
           THRESHOLDS = THRESHOLDS_float
        else: 
           THRESHOLDS = THRESHOLDS_insitu
