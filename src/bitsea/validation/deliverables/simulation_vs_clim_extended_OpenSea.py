...
from bitsea.static.climatology import get_climatology_open as get_climatology
...
O2o_clim, O2o_std = get_climatology('O2o', SUBLIST, LayerList,TheMask,basin_expand=True)
N4n_clim, N4n_std = get_climatology('N4n', SUBLIST, LayerList,TheMask,basin_expand=True)
N5s_clim, N5s_std = get_climatology('N5s', SUBLIST, LayerList,TheMask,basin_expand=True)
