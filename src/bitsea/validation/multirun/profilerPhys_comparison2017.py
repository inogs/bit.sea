...
BASEDIR[RUN_REF] = '/gpfs/scratch/userexternal/ateruzzi/ELAB_HC2017/VALID_float/' + \
    RUN_REF + '/PROFILATORE_PHYS/'
BASEDIR[RUN_DA] = '/gpfs/scratch/userexternal/ateruzzi/ELAB_HC2017/VALID_float/' + \
    RUN_DA + '/PROFILATORE_PHYS/'
