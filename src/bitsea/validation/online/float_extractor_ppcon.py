...
Profilelist=float_ppcon.FloatSelector(None,TI,OGS.med)
...
M.dumpModelProfiles(profilerscript) # sequential launch of aveScan # crea /PROFILATORE 

if args.outdir:
    M.getFloatMatchups(Profilelist,TheMask.zlevels,args.outdir) # /OUTPUTS_FLOATS/ANALISYS /OUTPUTS_FLOATS/FORECAST
