...
DIR_ORIG1km=/pico/scratch/userexternal/ateruzzi/SATELLITE/OLCI/ORIG/DT/
OBSTYPE=OLCI_DT
...
OUT_SUBMASK=/gss/gss_work/DRES_OGS_BiGe/Observations/CLIMATOLOGY/SAT/CCI_1km/SUBMASKsat/
# mkdir -p $OUT_SUBMASK
...
OUT_DIR=OUTPUT_$OBSTYPE
OUT_STATS=STATS_$OBSTYPE
