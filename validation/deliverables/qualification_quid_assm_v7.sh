...
export MASKFILE=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v19_3/wrkdir/MODEL/meshmask.nc
         ...
         INPUTDIR=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v20_1/wrkdir/MODEL/AVE_FREQ_2
   INPUT_AGGR_DIR=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v20_1/wrkdir/POSTPROC/output/AVE_FREQ_2/TMP
STAT_PROFILES_DIR=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v20_1/wrkdir/POSTPROC/output/AVE_FREQ_2/STAT_PROFILES
...
python averager_and_plot_map.py -i $INPUTDIR        -v ppn  -t integral $COMMONS_PARAMS  # Fig4.7 NPP-LAYER-Y-CLASS1-[CLIM/LIT]-MEAN per lo 0-200m

python averager_and_plot_map.py -i $INPUTDIR        -v Ac   -t mean $COMMONS_PARAMS   # Ac-LAYER-Y-CLASS1-[CLIM/LIT]-MEAN  --> not requested in the ScQP
...
INTEGRALS_PPN=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v20_1/wrkdir/POSTPROC/output/MONTHLY/PPN/INTEGRALS/PPN/ # girato un aveScan ridotto solo per loro
...
INPUTDIR_MON=/pico/scratch/userexternal/gbolzon0/eas_v12/eas_v20_1/wrkdir/POSTPROC/output/MONTHLY/AVE/
...
python simulation_vs_clim.py -i $STAT_PROFILES_MONTHLY_DIR -o sim_vs_clim_profiles/ -s 20150101 -e 20170101 -m $MASKFILE
cp sim_vs_clim_profiles/Fig_4.11*png Fig4.11
cp sim_vs_clim_profiles/Fig_4.19*png Fig4.19

DIR=static_clim
mkdir -p $DIR table4.6 table4.7 table 4.10/ table4.11 table4.13/ table4.14
# -------------------------------------------------------------------------
