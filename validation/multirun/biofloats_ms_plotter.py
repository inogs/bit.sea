...
from profiler import TL # obtained by a link
...
DATAfile1 = ncreader(args.inputfile1)
DATAfile2 = ncreader(args.inputfile2)
...
def single_plot(longvar, var, sub, layer, timeinterval ):
    ...
    bias1 = DATAfile1.plotdata(DATAfile1.bias   , var, sub, layer)
    rmse1 = DATAfile1.plotdata(DATAfile1.rmse   , var, sub, layer)
    numb1 = DATAfile1.plotdata(DATAfile1.npoints, var, sub, layer)
    
    bias2 = DATAfile1.plotdata(DATAfile2.bias   , var, sub, layer)
    rmse2 = DATAfile1.plotdata(DATAfile2.rmse   , var, sub, layer)
    numb2 = DATAfile1.plotdata(DATAfile2.npoints, var, sub, layer)    
...
#    ax2.set_yticklabels(ax2.yaxis.get_major_ticks(),fontsize=16)
    ...
    ax.plot(times,bias1,'m.-', label='V3 bias')
    ax.plot(times,rmse1,'k.-', label='V3 rmse')
    ax.plot(times,bias2,'r.-', label='V2 bias')
    ax.plot(times,rmse2,'g.-', label='V2 rmse')    
