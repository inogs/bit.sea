...
INPUTDIR_PHYS='/gpfs/scratch/userexternal/ateruzzi/' + RUN +'/wrkdir/MODEL/FORCINGS/'
...
BASEDIR_PHYS='/gpfs/scratch/userexternal/ateruzzi/ELAB_HC2017/VALID_float/' + RUN + '/PROFILATORE_PHYS/'
...
TL_PHYS = TimeList.fromfilenames(T_INT, INPUTDIR_PHYS,"T*.nc",prefix="T")
